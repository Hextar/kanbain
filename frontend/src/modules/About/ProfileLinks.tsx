...
const linkClass =
  "inline-flex cursor-pointer items-center gap-1.5 border-0 bg-transparent p-0 focus-visible:rounded-sm focus-visible:ring-2 focus-visible:ring-purple-500 focus-visible:outline-none";
